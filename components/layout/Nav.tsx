...
import { Reveal } from "../ui/motion/Reveals";
  ...
  return (
    <>
      <motion.header
        ...
        className="absolute top-0  z-50 backdrop-blur-lg border-b border-border/60 w-[80%] mx-auto right-0 left-0 mt-[3vh] rounded-2xl"
      >
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <motion.div variants={fadeUpBlur} className="flex items-center gap-2">
            <span
          ...
          <motion.nav
            variants={fadeUpBlur}
            className="hidden lg:flex items-center gap-8 text-sm text-foreground-secondary"
          >
            {LINKS.map((l) => (
          ...
          <motion.div variants={fadeUpBlur} className="hidden lg:flex items-center gap-2.5 ">
