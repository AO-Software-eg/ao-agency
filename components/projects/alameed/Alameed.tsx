...
function Elearning() {
    ...
    return (
        ...
        >
            ...
            <div className="mx-auto hidden w-[90%] max-w-7xl gap-12 lg:sticky lg:top-0 lg:grid lg:min-h-screen lg:grid-cols-[0.88fr_1.12fr] lg:items-center lg:gap-14 lg:py-16 motion-reduce:lg:hidden">
